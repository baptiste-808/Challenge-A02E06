...
![La clé USB est en GPT](LISTDISK1.png)
...
![La clé USB a bien été converti en format MBR](LISTDISK2.png)
...
![3 partitions au format RAW](DETAILDISK1.png)  
...
![Les partitions ont bien été formatées](DETAILDISK2.png)
